...
Install plone.deployment.training with uv.

```shell
uv add plone.deployment.training
```
...
- [Issue tracker](https://github.com/collective/plone-deployment-training/issues)
- [Source code](https://github.com/collective/plone-deployment-training/)
...
1.  Clone this repository.
    ...
    cd plone-deployment-training/backend
    ```
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-07-03 11:30:21.. A special thanks to all contributors and supporters!
