...
2. Go to your repository at [collective/plone-deployment-training](https://github.com/collective/plone-deployment-training).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `plone-deployment-training.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | plone-deployment-training.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | plone-deployment-training.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/plone-deployment-training/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/plone-deployment-training/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/plone-deployment-training-backend`) and Frontend (`ghcr.io/collective/plone-deployment-training-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of plone-deployment-training.example.com](https://github.com/collective/plone-deployment-training/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/plone-deployment-training.example.com.yml` stack.
